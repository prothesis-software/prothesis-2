...
build/windows/navigation_link.o
...
build/linux/navigation_link.o: src/navigation_link.cpp
	${CXX} ${CXXFLAGS} ${WX_CONFIG_LINUX} -c src/navigation_link.cpp \
	-o build/linux/navigation_link.o
...
build/windows/navigation_link.o: src/navigation_link.cpp
	${CXX_WIN} ${CXXFLAGS} ${WX_CONFIG_WINDOWS} -c src/navigation_link.cpp \
	-o build/windows/navigation_link.o
